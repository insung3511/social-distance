        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">스트리밍 화면</h1>
                    <p class="mb-4">실시간으로 카메라의 촬영장면을 송출받아 현재 상황을 볼 수 있는 스트리밍 화면입니다.</a></p>

                    <!-- DataTales -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">카메라 실시간 스트리밍 화면</h6>
                        </div>
                        <div class="card-body">
                            <div class="striming-responsive">
                                <!--<iframe src="../../street.jpg" width="100%" height="800"></iframe>-->
                                <?php
