...
if __name__== "__main__":
    ...
    sdc_path = input("[REQU] Input video Path (if you wanna real-time SocialDistance type \"0\")\n:: ")
    if (sdc_path == "0"):
    ...
    calculate_social_distancing(sdc_path, net_yl, output_dir, output_vid, ln1)
